...
if __name__ == '__main__':
    ...
    # phillip hue
    pubazure('home1','{"status": "ON"}')
    # time.sleep(20)
    # pubazure('wemo01', '{"status": "ON", "brightness": "9", "color": [1, 50, 100]}')
    # time.sleep(3)
    # pubazure('hue01','{"status": "ON", "brightness": "9", "color": [1, 50, 100]}')
    # time.sleep(3)
    # pubazure('fan01', '{"status": "ON", "brightness": "9", "color": [1, 50, 100]}')
    # time.sleep(3)
    # pubazure('daikin01','{"status": "OFF", "brightness": "9", "color": [1, 50, 100]}')
    # time.sleep(3)
    # pubazure('saijo01', '{"status": "ON", "brightness": "9", "color": [1, 50, 100]}')
    # time.sleep(3)
    # pubazure('saijo02', '{"status": "ON", "brightness": "9", "color": [1, 50, 100]}')
    # time.sleep(3)
    # pubazure('saijo03', '{"status": "ON", "brightness": "9", "color": [1, 50, 100]}')
    # time.sleep(3)
