...
class PowermeterAppAgent(PublishMixin, BaseAgent):
    ...
    def EV_energy_calculate(self):
        ...
        if (weekday == 5) | (weekday == 6) | (weekday == 7):  # provide "weekday = 7" for holiday rate
            EVdata['daily_EV_energy'] = self.integrate_power('3WIS221445K1200321', 'power', start_time, end_time)
            EVdata['daily_EV_bill'] = EVdata['daily_EV_energy'] * OFFPEAK_RATE
        else:
            ...
            EVdata['daily_EV_energy_peak'] = self.integrate_power('3WIS221445K1200321', 'power', start_time, end_time)
            EVdata['daily_EV_bill_peak'] = EVdata['daily_EV_energy_peak'] * PEAK_RATE
            ...
            EVdata['daily_energy_offpeak1'] = self.integrate_power('3WIS221445K1200321', 'power', start_time, end_time)
            EVdata['daily_EV_bill_offpeak1'] = EVdata['daily_EV_energy_offpeak1'] * OFFPEAK_RATE
            ...
            EVdata['daily_energy_offpeak2'] = self.integrate_power('3WIS221445K1200321', 'power', start_time, end_time)
            EVdata['daily_EV_bill_offpeak2'] = EVdata['daily_EV_energy_offpeak2'] * OFFPEAK_RATE

            # sum all period
            EVdata['daily_EV_energy'] = EVdata['daily_EV_energy_peak'] + EVdata['daily_EV_energy_offpeak1'] + EVdata[
                'daily_EV_energy_offpeak2']
            EVdata['daily_EV_bill'] = EVdata['daily_EV_bill_peak'] + EVdata['daily_EV_bill_offpeak1'] + EVdata[
                'daily_EV_bill_offpeak2']
        return EVdata
    ...
    def daily_energy_calculate(self):
        ...
        end_time = time_now
        start_time = end_time.replace(hour=0, minute=0, second=0)
        EV_data = self.EV_energy_calculate()
        ...
        if (weekday == 5)|(weekday == 6)|(weekday == 7):  #provide "weekday = 7" for holiday rate
            ...
            data['daily_light_energy'] = data['daily_energy'] * 0.1
            data['daily_light_bill'] = data['daily_light_energy'] * OFFPEAK_RATE
            data['daily_AC_energy'] = data['daily_energy'] * 0.5
            data['daily_AC_bill'] = data['daily_AC_energy'] * OFFPEAK_RATE
            data['daily_plug_energy'] = data['daily_energy'] - (data['daily_AC_energy'] + data['daily_light_energy'] + EV_data['daily_EV_energy'])
            data['daily_plug_bill'] = data['daily_plug_energy'] * OFFPEAK_RATE
        else:
            #Peak Period --- 09:00 - 22:00
            end_time = time_now.replace(hour=22, minute=0, second=0)
            start_time = time_now.replace(hour=9, minute=0, second=1)
            ...
            data['daily_light_energy_peak'] = data['daily_energy_peak'] * 0.1
            ...
            data['daily_plug_energy_peak'] = data['daily_energy_peak'] - (data['daily_AC_energy_peak'] + data['daily_light_energy_peak'] + EV_data['daily_EV_energy_peak'])
            ...
            data['daily_light_energy_offpeak1'] = data['daily_energy_offpeak1'] * 0.1
            ...
            data['daily_plug_energy_offpeak1'] = data['daily_energy_offpeak1'] - (data['daily_AC_energy_offpeak1'] + data['daily_light_energy_offpeak1'] + EV_data['daily_EV_energy_offpeak1'])
            ...
            data['daily_light_energy_offpeak2'] = data['daily_energy_offpeak2'] * 0.1
            ...
            data['daily_plug_energy_offpeak2'] = data['daily_energy_offpeak2'] - (data['daily_AC_energy_offpeak2'] + data['daily_light_energy_offpeak2'] + EV_data['daily_EV_energy_offpeak2'])
        ...
        if ((time_now >= (end_day_time - delta_time))&(time_now <= end_day_time)):
            try:
                variables = {'load_energy': data['daily_energy'], 'solar_energy': data['solar_daily_energy'],
                             ...
                             'plug_bill': data['daily_plug_bill'], 'EV_energy': EV_data['daily_EV_energy'],
                             'EV_bill': EV_data['daily_EV_bill']}
    ...
    def last_day_energy_calculate(self):
        ...
        start_time = time.replace(hour=23, minute=59, second=50)
        try:
    ...
    def publish_heartbeat(self):
        ...
        EV_daily_data = self.EV_energy_calculate()
        ...
        if (EV_daily_data['daily_EV_bill'] < PowermeterAppAgent.check_daily_data['daily_EV_bill']):
            EV_daily_data['daily_EV_bill'] = PowermeterAppAgent.check_daily_data['daily_EV_bill']
        ...
        daily_bill_EV = round(EV_daily_data['daily_EV_bill'], 2)
        ...
        PowermeterAppAgent.check_daily_data['daily_EV_bill'] = EV_daily_data['daily_EV_bill']
        PowermeterAppAgent.check_daily_data['daily_EV_energy'] = EV_daily_data['daily_EV_energy']
