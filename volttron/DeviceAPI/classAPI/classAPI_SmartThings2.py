...
class API:
    ...
    def getDeviceStatus(self):
        ...
        if deviceSummaryUrl.getcode() == 200:
            ...
            print 'deviceSummaryUrl.getcode() == 200:'
    ...
    def getDeviceStatusJson(self, data):
        ...
        # print len(_theJSON)
        # print _theJSON
        # for k,v in _theJSON.items():
        #     self.set_variable(k, v)
        # print _theJSON['status']
        # print _theJSON['device']['status']
        # self.set_variable('device_type', _theJSON['device']['name'])
        # self.set_variable('device_type', _theJSON['type'])
        # print self.get_variable('device_type')
        # if self.get_variable('device_type') == 'switch':
        #     self.set_variable('device_type', "plugload")
        # self.set_variable('device_network_status', "ACTIVE")  # need to remove later
        # print _theJSON['device']['status']
        self.set_variable('device_type', _theJSON['device']['name'])
        ...
        # self.set_variable('nick_name', _theJSON['label'])
        ...
        # if _theJSON['type'] == 'switch':
        #     try:
        #         if _theJSON['status'] == "on":
        #             # print _theJSON['device']['currentStates'][0]['value']
        #             self.set_variable('status', "ON")
        #         elif _theJSON['status'] == "off":
        #             # print _theJSON['device']['currentStates'][0]['value']
        #             self.set_variable('ste79e128e-8003-45a5-9e72-e9cdfa662136atus', "OFF")
        #     except KeyError: pass
        elif _theJSON['device']['name'] == 'SmartSense Motion/Temp Sensor':
        ...
        for k,v in postmsg.items():
            if k == 'status':
                if postmsg.get('status') == "ON":
                    ...
                    # self.set_variable("t_heat",podeviceSummaryUrl.getcode() == 200:stmsg.get("heat_setpoint"))
...
def main():
    ...
    # SmartThings = API(model='switch', agent_id='SmartThingsSwitch1', api='API1',
    #                   auth_header='Bearer 40970778-6cc9-4ae5-be82-2362713a8ea0', smt_username='kwarodom@hotmail.com', smt_password='w3300136',
    #                   # address_get='https://graph.api.smartthings.com/api/devices/e79e128e-8003-45a5-9e72-e9cdfa662136',
    #                   # address_get='https://graph.api.smartthings.com/api/smartapps/installations/'
    #                   #             '1ac27145-9907-4c80-9bb7-07ce51e70e9d/contactSensors/e79e128e-8003-45a5-9e72-e9cdfa662136',
    #                   # address_get='https://graph.api.smartthings.com/api/smartapps/installations/'
    #                   #             '1ac27145-9907-4c80-9bb7-07ce51e70e9d/motions/433b808d-1b55-406a-bbf6-4db0e18bbbad',
    #                   # address_get='https://graph.api.smartthings.com/api/smartapps/installations/'
    #                   #             '1ac27145-9907-4c80-9bb7-07ce51e70e9d/switches/cca19281-b6cc-4bb1-b642-a7e17a98bb93',
    #                   # address_get='https://graph.api.smartthings.com/api/smartapps/installations/'
    #                   #             '1ac27145-9907-4c80-9bb7-07ce51e70e9d/temperatures/433b808d-1b55-406a-bbf6-4db0e18bbbad',
    #                   address_get='https://graph.api.smartthings.com/api/devices/55b504af-31cc-4ba2-85cb-34950f54c6ea',
    #                   address_put='https://graph.api.smartthings.com/api/smartapps/installations/cca19281-b6cc-4bb1-b642-a7e17a98bb93'
    #                               '1ac27145-9907-4c80-9bb7-07ce51e70e9d/switches/cca19281-b6cc-4bb1-b642-a7e17a98bb93')
    #
    ...
    SmartThings.discoverHub('kwarodom@hotmail.com', 'w3300136')
    SmartThings.getHubDevices('kwarodom@hotmail.com', 'w3300136')

    # SmartThings.getDeviceStatus()

    # SmartThings.setDeviceStatus({"status": "ON"})
